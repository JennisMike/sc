...
const ChatMessageSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'senderAvatarUrl': PropertySchema(
      id: 7,
      name: r'senderAvatarUrl',
      type: IsarType.string,
    ),
...
int _chatMessageEstimateSize(
  ...
  {
    final value = object.senderAvatarUrl;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
  bytesCount += 3 + object.senderDisplayName.length * 3;
...
void _chatMessageSerialize(
  ...
  writer.writeString(offsets[4], object.messageText);
  writer.writeString(offsets[5], object.messageType);
  writer.writeString(offsets[6], object.metadataJson);
  writer.writeString(offsets[7], object.senderAvatarUrl);
  writer.writeString(offsets[8], object.senderDisplayName);
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    ...
    messageText: reader.readStringOrNull(offsets[4]),
    messageType: reader.readString(offsets[5]),
    senderAvatarUrl: reader.readStringOrNull(offsets[7]),
    senderDisplayName: reader.readString(offsets[8]),
...
extension ChatMessageQueryWhereSort
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryWhere
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> createdAtBetween(
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      senderAvatarUrlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'senderAvatarUrl',
      ));
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      senderAvatarUrlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'senderAvatarUrl',
      ));
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      senderAvatarUrlContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'senderAvatarUrl',
        value: value,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      senderAvatarUrlMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'senderAvatarUrl',
        wildcard: pattern,
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortBySenderAvatarUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderAvatarUrl', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortBySenderAvatarUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderAvatarUrl', Sort.desc);
    });
  }
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenBySenderAvatarUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderAvatarUrl', Sort.asc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctBySenderAvatarUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'senderAvatarUrl',
          caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctBySenderDisplayName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, String?, QQueryOperations>
      senderAvatarUrlProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'senderAvatarUrl');
    });
  }
